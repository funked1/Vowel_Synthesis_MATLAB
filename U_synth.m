...
ff1  = 315;      % first formant frequency
HPF1 = 365;      % high-pass cutoff frequency (Hz)
LPF1 = 265;      % low-pass cutoff frequency (Hz)

ff2  = 2350;     % second formant frequency
HPF2 = 2400;     % high-pass cutoff frequency (Hz)
LPF2 = 2300;     % low-pass cutoff frequency (Hz)

ff3  = 3300;     % third formant frequency
HPF3 = 3350;     % high-pass cutoff frequency (Hz)
LPF3 = 3250;     % low-pass cutoff frequency (Hz)
