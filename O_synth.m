...
ff1  = 690;      % first formant frequency
HPF1 = 740;      % high-pass cutoff frequency (Hz)
LPF1 = 640;      % low-pass cutoff frequency (Hz)

ff2  = 3250;     % second formant frequency
HPF2 = 3300;     % high-pass cutoff frequency (Hz)
LPF2 = 3200;     % low-pass cutoff frequency (Hz)

ff3  = 5500;     % third formant frequency
HPF3 = 5525;     % high-pass cutoff frequency (Hz)
LPF3 = 5475;     % low-pass cutoff frequency (Hz)
